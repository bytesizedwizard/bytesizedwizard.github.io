...
export const projects: Project[] = [
  {
    ...
    tech: ['Swift', 'SwiftUI', 'Kotlin', 'Jetpack Compose', 'AES Encryption', 'RFC 6238'],
    status: 'stable',
    featured: true,
    featuredBg: '#02140E',
    links: {
  ...
  },
  {
    ...
    tech: ['TypeScript', 'React', 'Node.js', 'PostgreSQL', 'Docker', 'WebSockets'],
    status: 'wip',
    links: {
  ...
  },
  {
    ...
    tech: ['TypeScript', 'Node.js', 'Commander.js', 'Handlebars', 'npm'],
    status: 'stable',
    links: {
